...
export const formTemplateRegister = () => {
  const viewForm = `<div class="fondGif">
     <div class="formFond">
...
const validateInputs = () => {
  ...
  inputPassword.addEventListener("keyup", (e) => {
    if (reguex.password.test(e.target.value)) {
      document
        .getElementById("group-password")
        .classList.remove("form-group-fail");
      document
        .getElementById("group-password")
        .classList.add("form-group-valid");
      document
        .querySelector("#group-password i")
        .classList.remove("fa-times-circle");
      document
        .querySelector("#group-password i")
